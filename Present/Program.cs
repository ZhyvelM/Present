...
namespace Present
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //gift.Add(new CandyBar("Snickers", "Nutella", 100, 10, 5, true));
            //gift.Add(new Lolipop("Chupa Chups", "Chupa Chups", 30, 5, 1, 3));
            //gift.Add(new BubbleGum("Hubba bubba", "Wrigley", 60, 10, 2, 4));
            ...
            while (flag)
            {
                ...
                switch (c)
                {
                    case ('1'):
                        {
                            gift.Add(new CandyBar("Nuts", "Nutella", 100, 10, 1, true));
